...
async function selectiveReset() {
  console.log('Starting selective reset to preserve users and teams...');
  ...
  try {
    ...
    // Preserve: teams, users, tokens, and device details
    console.log('Preserving teams, users, tokens, and device details...');
